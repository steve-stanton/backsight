...
{
    /// <summary>
    /// An item of text with <see cref="RowTextGeometry"/>.
    /// </summary>
    class RowTextFeature : TextFeature
    {
        internal RowTextFeature(EditDeserializer editDeserializer)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RowTextFeature"/> class, and records it
        ...
        internal RowTextFeature(IFeature f, RowTextGeometry geom, bool isTopological, PointGeometry polPosition)
