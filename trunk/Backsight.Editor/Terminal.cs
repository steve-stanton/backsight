...
namespace Backsight.Editor
{
    ...
    /// <summary>
    /// Dumb implementation of <see cref="ITerminal"/> that has no incident polygon boundaries.
    /// </summary>
    ...
    class Terminal : PointGeometry, ITerminal
    {
        ...
        /// <summary>
        /// Returns null, indicating that no polygon boundaries start or end at this terminal.
        /// </summary>
