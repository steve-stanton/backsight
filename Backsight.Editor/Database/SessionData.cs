...
namespace Backsight.Editor.Database
{
    ...
    class SessionData
    {
        ...
        static void LoadSessions(SqlConnection con, List<SessionData> sessions, Job job)
        {
        ...
        SessionData(uint sessionId, uint jobId, uint userId, DateTime start, DateTime end, uint numItem)
        {
