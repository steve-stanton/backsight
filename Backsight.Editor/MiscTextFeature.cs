...
namespace Backsight.Editor
{
    ...
    {
        internal MiscTextFeature(EditDeserializer editDeserializer)
        ...
        internal MiscTextFeature(IFeature f, MiscTextGeometry geom, bool isTopological, PointGeometry polPosition)
