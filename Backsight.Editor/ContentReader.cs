...
namespace Backsight.Editor
{
    ...
    class ContentReader
    {
        ...
        internal ContentReader(uint numItem)
        {
            //m_Model = model;
            m_Reader = null;
        ...
        */
        ...
        internal T ReadElement<T>(string name) where T : IContentElement
        {
        ...
        internal uint ReadUnsignedInt(string name)
        {
            string s = m_Reader[name];
        ...
        internal string[] ReadStringArray(string itemName)
        {
            // Ensure we're at an element
        ...
        /*
        internal Id[] ReadIdArray(string itemName)
        {
