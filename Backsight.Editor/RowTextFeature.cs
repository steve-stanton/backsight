...
namespace Backsight.Editor
{
    ...
    class RowTextFeature : TextFeature
    {
        ...
        internal RowTextFeature(InternalIdValue iid, FeatureId fid, IEntity ent, Operation creator,
            RowTextGeometry geom, bool isTopological, PointGeometry polPosition)
