...
namespace Backsight.Editor.Content
{
    public class ContentWriter
    {
        ...
        /// <param name="edit">The edit to convert into XML</param>
        ContentWriter(XmlWriter writer, Edit edit)
        {
            m_Writer = writer;
            m_Edit = edit;
        }
        ...
        void Write()
        {
            ...
            WriteElement("Edit", m_Edit);

            m_Writer.WriteEndElement();
        }

        public void WriteElement(string name, IContentElement ce)
        {
        ...
        public void WriteStringArray(string itemName, string[] data)
        {
        ...
        public void WriteArray(string itemName, IContentAttribute[] items)
        {
            m_Writer.WriteStartElement(itemName+"Array");
        ...
        public void WriteIdArray(string itemName, Id[] items)
        {
