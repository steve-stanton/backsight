...
class ControlPoint : Position3D, IEquatable<ControlPoint>
{
    ...
    static ControlPoint CreateInstance(string s)
    {
        ...
        double easting;
        if (!Double.TryParse(t, out easting) || easting < MathConstants.TINY)
        ...
        double northing;
        if (!Double.TryParse(t, out northing) || northing < MathConstants.TINY)
    ...
    /// </summary>
    internal bool IsDefined => X > MathConstants.TINY;
    ...
    /// </summary>
    internal uint ControlId => m_ControlId;
