...
abstract class Operation : Change, IFeatureDependent
{
    ...
    protected Operation(IMapStore store) : base(store)
    {
        m_Session = store.Model.WorkingSession ?? throw new ArgumentNullException();
    }
    ...
    /// never null).
    /// </summary>
    internal abstract Feature[] Features { get; }
    ...
    public virtual uint FeatureCount => (uint)Features.Length;

    /// <summary>
    /// The session in which this operation was originally defined (never null).
    /// </summary>        
    internal Session Session => m_Session;

    /// <summary>
    /// The coordinate system of the map model this operation is part of.
    /// </summary>
    internal ISpatialSystem SpatialSystem => MapModel.SpatialSystem;

    /// <summary>
    /// The map model this operation is part of.
    /// </summary>
    internal CadastralMapModel MapModel => m_Session.MapModel;

    /// <summary>
    /// The store that this operation is part of.
    /// </summary>
    internal IMapStore MapStore => m_Session.MapStore;
    ...
    /// </summary>
    internal abstract EditingActionId EditId { get; }
    ...
    /// <see cref="CadastralMapModel.CleanEdit"/> will be made, and the edit will be saved.
    /// </summary>
    protected void Complete()
    {
        // Is this method being called as part of application startup?
        bool isStartup = !ReferenceEquals(m_Session, MapStore.Model.WorkingSession);
    ...
    {
        get => IsFlagSet(OperationFlag.ToCalculate);
    ...
    /// </summary>
    bool IsTouched => IsFlagSet(OperationFlag.Touched);
    ...
    private IWindow? GetFeatureExtent()
    {
