...
public class IntersectionData : IComparable<IntersectionData>
{
    ...
    internal bool IsGraze => m_X1 is not null && m_X2 is not null;
    ...
    internal bool IsEndEnd
    {
        get
        {
            var mask = IntersectionType.TouchStart | IntersectionType.TouchEnd;
            return (m_Context1 & mask) != 0 && (m_Context2 & mask) != 0;
        }
    }

    internal bool IsEnd => (m_Context1 & (IntersectionType.TouchStart | IntersectionType.TouchEnd)) != 0;

    internal bool IsStartGraze => (m_Context1 & IntersectionType.GrazeStart) != 0;

    internal bool IsEndGraze => (m_Context1 & IntersectionType.GrazeEnd) != 0;

    internal bool IsInteriorGraze => (m_Context1 & IntersectionType.GrazeOther) != 0;

    internal bool IsTotalGraze => (m_Context1 & IntersectionType.GrazeTotal) != 0;
    ...
    /// </summary>
    internal bool IsDefined => m_X1 is not null;
