...
class LegFace : IPersistent
{
    ...
    internal LegFace(EditDeserializer editDeserializer)
    {
        ...
        if (editDeserializer.CurrentEdit is not PathOperation op)
        ...
        DistanceUnit defaultEntryUnit = DistanceUnit.GetUnit(op.MapStore.Settings.EntryUnit);
    ...
    /// </summary>
    internal int NumSpan => m_Spans.Length;
    ...
    /// </summary>
    internal SpanInfo[] Spans => m_Spans;
