...
public class TextFeature : Feature
{
    ...
    /// </summary>
    public override IWindow Extent => m_Geom.Extent;
    ...
    internal IPointGeometry? GetPolPosition()
    {
        ...
        if (m_PolygonPosition is not null)
    ...
    internal void SetPolPosition(IPointGeometry? p)
    {
        ...
        // If the label was previously "built", re-calculate the relationship to any enclosing polygon
    ...
    public string ContainerId => (m_Container==null ? String.Empty : m_Container.ToString());
    ...
    /// </summary>
    internal IPointGeometry Position => m_Geom.Position;
