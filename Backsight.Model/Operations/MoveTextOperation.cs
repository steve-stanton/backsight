...
class MoveTextOperation : Operation
{
    ...
    /// The feature that was moved.
    /// </summary>
    internal TextFeature MovedText => m_Text;
    ...
    /// </summary>
    public override string Name => "Move text";
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.MoveLabel;
