...
class SimpleLineSubdivisionOperation : Operation, IRecallable, IRevisable
{
    ...
    /// The distance to the point.
    /// </summary>
    internal Distance Distance => m_Distance;

    /// <summary>
    /// Is the distance observed from the end of the line?
    /// </summary>
    internal bool IsFromEnd => m_IsFromEnd;
    ...
    internal static IPosition Calculate(LineFeature line, Distance dist, bool isFromEnd)
    {
        ...
        double planlen = dist.GetPlanarMetric(start, approx, line.SpatialSystem);
    ...
    {
        var section = new SectionGeometry(m_Line, start, end);
    ...
    /// </summary>
    public override string Name => "Line subdivide (one distance)";

    /// <summary>
    /// The features created by this editing operation.
    /// </summary>
    internal override Feature[] Features => [m_NewLine1, m_NewPoint, m_NewLine2];

    /// <summary>
    /// The unique identifier for this edit.
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.SimpleLineSubdivision;
