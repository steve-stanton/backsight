...
class IntersectDirectionAndDistanceOperation : IntersectOperation, IRecallable, IRevisable, IFeatureRef
{
    ...
    /// The observed distance (either a <see cref="Distance"/>, or an <see cref="OffsetPoint"/>).
    /// </summary>
    internal Observation Distance => m_Distance;

    /// <summary>
    /// The point the distance was measured from.
    /// </summary>
    internal PointFeature DistanceFromPoint => m_From; // was GetpDistFrom

    /// <summary>
    /// The first line created (if any). Should always be null if the direction
    /// has an offset.
    /// </summary>
    internal LineFeature CreatedDirectionLine => m_DirLine; // was GetpDirArc

    /// <summary>
    /// The second line created (if any).
    /// </summary>
    internal LineFeature CreatedDistanceLine => m_DistLine; // was GetpDistArc
    ...
    /// </summary>
    public override string Name => "Direction - distance intersection";
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.DirDistIntersect;
        ...
        out IPosition xsect, out IPosition xsect1, out IPosition xsect2)
    {
        ...
        dist = dist * CoordinateSystem.GetLineScaleFactor(from, xsect);
