...
abstract class NewTextOperation : Operation //, IRevisable
{
	...
	protected NewTextOperation(IMapStore store)
		: base(store)
	{
		m_NewText = null;
	}
	...
	/// The text label that was created
	/// </summary>
	internal TextFeature Text => m_NewText;
	...
	/// </summary>
	public override string Name => "Add new text";

	/// <summary>
	/// The features created by this editing operation.
	/// </summary>
	internal override Feature[] Features => [m_NewText];

	/// <summary>
	/// The unique identifier for this edit.
	/// </summary>
	internal override EditingActionId EditId => EditingActionId.NewText;
