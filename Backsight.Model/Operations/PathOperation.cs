...
class PathOperation : Operation, IRecallable, IRevisable
{
    ...
    /// <param name="defaultEntryUnit"></param>
        ...
        : base(from.MapStore)
    {
        ...
        Session.MapStore.ItemCount = lastId;
        ...
        : base(editDeserializer)
    {
        ...
        // any alternate faces).
        FeatureStub[] stubs = CreateStubs(pointType, lineType);
    ...
    FeatureStub[] CreateStubs(IEntity pointType, IEntity lineType)
    {
    ...
    /// </summary>
    public override string Name => "Connection path";
    ...
    internal override Feature[] Features
    {
        get
        {
            var result = new List<Feature>(100);
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.Path;
...
*/
    ...
    internal void Execute()
    {
        ...
        var settings = Session.MapStore.Settings;
        FeatureStub[] stubs = CreateStubs(settings.DefaultPointType, settings.DefaultLineType);
    ...
    void AttachGeometry(EditingContext ctx, SpanInfo[] spans, ILineGeometry[] sections)
    {
        ...
        for (int i = 0; i < spans.Length; i++)
        {
            ...
            {
                var pg = PointGeometry.Create(sections[i].End);
...
*/
    ...
    */
    ...
    /// The data entry string that defines the connection path.
    /// </summary>
    internal string EntryString => m_EntryString;

    /// <summary>
    /// The default distance units to use when decoding the data entry string.
    /// </summary>
    internal DistanceUnit EntryUnit => m_DefaultEntryUnit;
    ...
    public override void WriteData(EditSerializer editSerializer)
    {
        ...
        editSerializer.WriteEntity(DataField.PointType, Session.MapStore.Settings.DefaultPointType);
        editSerializer.WriteEntity(DataField.LineType, Session.MapStore.Settings.DefaultLineType);
