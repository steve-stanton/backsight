...
abstract class IntersectOperation : Operation
{
    ...
    protected IntersectOperation(IMapStore store)
        : base(store)
    {
    }
    ...
    /// </summary>
    internal abstract PointFeature IntersectionPoint { get; } // was GetpIntersect
    ...
    /// </summary>
    internal abstract PointFeature ClosePoint { get; }
