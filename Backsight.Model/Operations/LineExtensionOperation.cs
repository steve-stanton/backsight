...
class LineExtensionOperation : Operation, IRecallable, IRevisable
{
    ...
    /// </summary>
    internal LineFeature ExtendedLine => m_ExtendLine;
    ...
    /// The observed length of the extension.
    /// </summary>
    internal Distance Length => m_Length;

    /// <summary>
    /// Is the extension from the end of <see cref="ExtendLine"/>
    /// </summary>
    internal bool IsExtendFromEnd => m_IsExtendFromEnd;
    ...
    IPosition? Calculate()
    {
        ...
        if (m_ExtendLine is ArcFeature arc)
        {
            ok = arc.CalculateExtension(m_IsExtendFromEnd, m_Length,
                out _, out end, out _, out _);
        }
        else
        {
            ok = m_ExtendLine.CalculateExtension(m_IsExtendFromEnd, m_Length,
                out _, out end);
        }
    ...
    /// </summary>
    public override string Name => "Line extension";
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.LineExtend;
