...
abstract class NewLineOperation : Operation
{
    ...
    protected NewLineOperation(IMapStore store)
        : base(store)
    {
        m_NewLine = null;
    }
    ...
    /// The created line
    /// </summary>
    internal LineFeature Line => m_NewLine;
    ...
    internal override Feature[] Features => [m_NewLine];

    internal override EditingActionId EditId => EditingActionId.NewLine;
    ...
    {
        return [m_NewLine.StartPoint, m_NewLine.EndPoint];
    }
