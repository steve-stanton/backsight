...
class IntersectTwoLinesOperation : IntersectOperation, IRecallable
{
    ...
    /// The 1st line to intersect.
    /// </summary>
    internal LineFeature Line1 => m_Line1; // was GetpArc1

    /// <summary>
    /// True if the 1st line needs to be split at the intersection.
    /// </summary>
    internal bool IsSplit1 => m_IsSplit1;

    //set { m_IsSplit1 = value; }
    /// <summary>
    /// The 2nd line to intersect.
    /// </summary>
    internal LineFeature Line2 => m_Line2; // was GetpArc2

    /// <summary>
    /// True if the 2nd line needs to be split at the intersection.
    /// </summary>
    internal bool IsSplit2 => m_IsSplit2;
    ...
    /// </summary>
    public override string Name => "Intersect two lines";
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.LineIntersect;
    ...
    private IPosition? Calculate()
    {
        IPosition xsect;
        if (m_Line1.Intersect(m_Line2, m_CloseTo, out xsect, out _))
            return xsect;
        else
            return null;
    }
    ...
    internal override void ProcessFeatures(FeatureFactory ff)
    {
        ...
        if (m_IsSplit1)
        {
            LineFeature lineBefore1, lineAfter1;
        ...
        if (m_IsSplit2)
        {
            LineFeature lineBefore2, lineAfter2;
    ...
    /// The portion of m_Line1 prior to the intersection (null if m_IsSplit1==false).
    /// </summary>
    internal LineFeature Line1BeforeSplit => m_Line1a;

    /// <summary>
    /// The portion of m_Line1 after the intersection (null if m_IsSplit1==false).
    /// </summary>
    internal LineFeature Line1AfterSplit => m_Line1b;

    /// <summary>
    /// The portion of m_Line2 prior to the intersection (null if m_IsSplit2==false).
    /// </summary>
    internal LineFeature Line2BeforeSplit => m_Line2a;

    /// <summary>
    /// The portion of m_Line2 after the intersection (null if m_IsSplit2==false).
    /// </summary>
    internal LineFeature Line2AfterSplit => m_Line2b;
