...
class IntersectTwoDirectionsOperation : IntersectOperation, IRecallable, IRevisable
{
    ...
    /// The first line created (if any).
    /// </summary>
    internal LineFeature CreatedLine1 => m_Line1;

    /// <summary>
    /// The second line created (if any).
    /// </summary>
    internal LineFeature CreatedLine2 => m_Line2;
    ...
    /// The first observed direction
    /// </summary>
    internal Direction Direction1 => m_Direction1;

    /// <summary>
    /// The second observed direction
    /// </summary>
    internal Direction Direction2 => m_Direction2;
    ...
    /// </summary>
    public override string Name => "Direction - direction intersection";
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.DirIntersect;
