...
class NewCircleOperation : NewLineOperation, IRecallable //, IRevisable
{
    ...
    /// Point at the center of the circle.
    /// </summary>
    internal PointFeature Center => m_Center;
    ...
    /// the circle.
    /// </summary>
    internal Observation Radius => m_Radius;

    /// <summary>
    /// A user-perceived title for this operation.
    /// </summary>
    public override string Name => "Add new circle";

    /// <summary>
    /// The unique identifier for this edit.
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.NewCircle;
    ...
    internal override void CalculateGeometry(EditingContext ctx)
    {
        ...
        if (p.Creator == this)
        {
            var pg = new PointGeometry(m_Center.X, m_Center.Y+rad);
