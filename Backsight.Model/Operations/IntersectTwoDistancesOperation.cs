...
class IntersectTwoDistancesOperation : IntersectOperation, IRecallable, IRevisable, IFeatureRef
{
    ...
    /// </summary>
    internal Observation Distance1 => m_Distance1;

    /// <summary>
    /// The second observed distance (either a <see cref="Distance"/>, or an <see cref="OffsetPoint"/>).
    /// </summary>
    internal Observation Distance2 => m_Distance2;

    /// <summary>
    /// The point the 1st distance was measured from.
    /// </summary>
    internal PointFeature Distance1FromPoint => m_From1;

    /// <summary>
    /// The point the 2nd distance was measured from.
    /// </summary>
    internal PointFeature Distance2FromPoint => m_From2;

    /// <summary>
    /// The first line created (if any).
    /// </summary>
    internal LineFeature CreatedLine1
    {
        get => m_Line1;
        set => m_Line1 = value;
    }
    ...
    /// </summary>
    internal LineFeature CreatedLine2
    {
        get => m_Line2;
        set => m_Line2 = value;
    }
    ...
    /// </summary>
    internal override PointFeature IntersectionPoint => m_To;

    /// <summary>
    /// Was the intersection created at it's default position?
    /// </summary>
    internal override bool IsDefault => m_Default;
    ...
    /// returns null.
    /// </summary>
    internal override PointFeature ClosePoint => null;

    /// <summary>
    /// A user-perceived title for this operation.
    /// </summary>
    public override string Name => "Distance - distance intersection";
    ...
    /// </summary>
    internal override EditingActionId EditId => EditingActionId.DistIntersect;
        ...
        out IPosition xsect, out IPosition xsect1, out IPosition xsect2)
    {
        ...
        if (d1 < MathConstants.TINY || d2 < MathConstants.TINY)
            return false;
        ...
        if (offset1==null)
            d1 = d1 * CoordinateSystem.GetLineScaleFactor(from1, xsect);

        if (offset2==null)
            d2 = d2 * CoordinateSystem.GetLineScaleFactor(from2, xsect);
