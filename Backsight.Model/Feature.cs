...
public abstract class Feature : IMapObject, IPossibleList<Feature>, IFeature, IExpandablePropertyItem, IPersistent
{
    ...
    /// <summary>
    /// The user-perceived ID of this feature (may be shared by multiple features).
    /// </summary>
    FeatureId? m_Id;
    ...
    {
        m_Creator = creator ?? throw new ArgumentNullException("Creating operation must be defined");
        m_InternalId = id;
        m_What = entityType ?? throw new ArgumentNullException("Entity type must be defined");
        m_References = null;
        m_Flag = 0;
    ...
    /// <summary>
    /// The store that this feature is part of.
    /// </summary>
    internal IMapStore MapStore => m_Creator.MapStore;
    ...
    /// <summary>
    /// The user-perceived ID (if any) for the feature. This is the ID
    /// used to associate the feature with any miscellaneous attributes
    ...
    {
        get => IsFlagSet(FeatureFlag.ForeignId);
    ...
    /// <summary>
    /// Assigns the next available ID to this feature. The feature cannot already have an ID.
    /// </summary>
    internal void SetNextId()
    {
        if (MapModel.WorkingSession is Session s)
        {
    ...
    /// </summary>
    internal bool IsTopological => IsFlagSet(FeatureFlag.Topol);
    ...
    /// </summary>
    internal bool IsBuilt => IsFlagSet(FeatureFlag.Built);
    ...
    {
        get => IsFlagSet(FeatureFlag.Moved);
    ...
    {
        get => IsFlagSet(FeatureFlag.Trim);
    ...
    {
        get => (IsFlagSet(FeatureFlag.Inactive) || IsFlagSet(FeatureFlag.Undoing));
    ...
    {
        get => IsFlagSet(FeatureFlag.Undoing);
    ...
    {
        MapModel.EditingIndex.RemoveFeature(this);
    }
    ...
    {
        get => IsFlagSet(FeatureFlag.Void);
    ...
    {
        get => IsFlagSet(FeatureFlag.Indexed);
