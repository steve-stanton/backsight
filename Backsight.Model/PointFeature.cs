...
public class PointFeature : Feature, IPoint, ITerminal, IMapPoint
{
    ...
    {
        return Dependents?.OfType<Circle>().ToArray() ?? [];
    }

    /// <summary>
    /// The geometry defining the position of this feature.
    /// </summary>
    public IPointGeometry Geometry => m_Geom;

    /// <summary>
    /// The geometry defining the position of this feature.
    /// </summary>
    internal PointGeometry PointGeometry => m_Geom;
    ...
    public ILength Easting => m_Geom.Easting;

    public ILength Northing => m_Geom.Northing;
    ...
    {
        return $"{InternalId} {m_Geom.ToString()}";
    }
