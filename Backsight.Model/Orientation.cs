...
class Orientation
{
    ...
    internal bool IsStart => m_IsStart;

    internal Quadrant Quadrant => m_Quadrant;

    internal double Angle => m_DeltaI/m_DeltaJ;

    internal double LengthSquared => (m_DeltaI*m_DeltaI + m_DeltaJ*m_DeltaJ);
    ...
    /// </summary>
    internal bool IsDividerArc => m_Divider?.Line is ArcFeature;
