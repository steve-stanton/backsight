...
class Extent : IEquatable<Extent>
{
    ...
    /// </summary>
    /// <param name="o">The spatial object that will define the extent</param>
    internal Extent(IMapObject o)
        : this(o.Extent)
    {
    }
    ...
    {
        ulong val = MapIndex.ToUnsigned(p.Easting.Microns);
        if (val<m_X.Min || val>m_X.Max)
            return false;

        val = MapIndex.ToUnsigned(p.Northing.Microns);
    ...
    /// </summary>
    internal ulong MinX => m_X.Min;

    /// <summary>
    /// The southern edge, in microns
    /// </summary>
    internal ulong MinY => m_Y.Min;

    /// <summary>
    /// The eastern edge, in microns
    /// </summary>
    internal ulong MaxX => m_X.Max;

    /// <summary>
    /// The northern edge, in microns
    /// </summary>
    internal ulong MaxY => m_Y.Max;

    /// <summary>
    /// Is this window square?
    /// </summary>
    internal bool IsSquare => (this.Width==this.Height);

    /// <summary>
    /// The width of the extent, in microns
    /// </summary>
    internal ulong Width => m_X.Size;

    /// <summary>
    /// The height of the extent, in microns
    /// </summary>
    internal ulong Height => m_Y.Size;
