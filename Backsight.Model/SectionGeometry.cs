...
public class SectionGeometry : LineGeometry, ISection
{
    ...
    /// </summary>
    public ITerminal From => StartTerminal;

    /// <summary>
    /// The end position for the section.
    /// </summary>
    public ITerminal To => EndTerminal;

    /// <summary>
    /// The geometry that acts as the base for this section.
    /// </summary>
    internal override UnsectionedLineGeometry SectionBase => m_Base.LineGeometry.SectionBase;

    /// <summary>
    /// The line that the section is based on.
    /// </summary>
    internal LineFeature BaseLine => m_Base;
