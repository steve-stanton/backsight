...
public class MultiSegmentGeometry : UnsectionedLineGeometry, IMultiSegmentGeometry
{
    ...
    public override IWindow Extent => m_Extent;

    public override ILength Length => LineStringGeometry.GetLength(this, null, null);
    ...
    {
        return BasicGeom.DistanceSquared(testX, testY, xs, ys, xe, ye) < Constants.XYTOLSQ;
    }
    ...
    public IPointGeometry[] Data => m_Data; // implements IMultiSegmentGeometry
