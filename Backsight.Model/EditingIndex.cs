...
class EditingIndex : MapIndex
{
    ...
    {
        IMapObject? o = m_ExtraData.QueryClosest(p, tol, SpatialType.Line);
        if (o is null)
            return null;

        Debug.Assert(o is Circle);
        return o as Circle;
    }
