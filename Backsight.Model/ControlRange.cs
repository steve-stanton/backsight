...
class ControlRange
{
    ...
    /// </summary>
    internal int NumControl => m_Control?.Length ?? 0;

    /// <summary>
    /// Number of control points that have been defined within the range.
    /// </summary>
    internal int NumDefined => m_NumDefined;

    /// <summary>
    /// The low end of the range.
    /// </summary>
    internal uint Min => m_MinId;

    /// <summary>
    /// The high end of the range.
    /// </summary>
    internal uint Max => m_MaxId;
    ...
    internal ControlPoint[] GetDefinedPoints()
    {
        ...
        return m_Control.Where(cp => cp is not null).ToArray();
    }
