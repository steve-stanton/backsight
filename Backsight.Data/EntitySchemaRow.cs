...
namespace Backsight.Data
{
    ...
    {
        partial class EntitySchemaRow
        {
            /// <summary>
            /// Checks an array of <c>EntitySchemaRow</c> to see if any element refers
            /// to a specific table.
            /// </summary>
            ...
            internal static bool IsTableInArray(ITable t, EntitySchemaRow[] rows)
            {
                int tableId = t.Id;

                foreach (EntitySchemaRow row in rows)
                {
