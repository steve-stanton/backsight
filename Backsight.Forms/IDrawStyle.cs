...
public interface IDrawStyle
{
    ...
    void Render(ISpatialGraphics display, IEnumerable<IPosition> line);
    ...
    void Render(ISpatialGraphics display, IPosition start, IPosition end);
    ...
    void Render(ISpatialGraphics display, IPosition position);
    ...
    /// <param name="display">The display to draw to</param>
    /// <param name="position">The position of the center of the point</param>
    void RenderPlus(ISpatialGraphics display, IPosition position);
    ...
    /// <param name="display">The display to draw to</param>
    /// <param name="position">The position of the center of the point</param>
    void RenderTriangle(ISpatialGraphics display, IPosition position);
    ...
    void Render(ISpatialGraphics display, IPosition position, Icon icon);
    ...
    void Render(ISpatialGraphics display, IClockwiseCircularArcGeometry arc);
    ...
    void Render(ISpatialGraphics display, IString text);
    ...
    void Render(ISpatialGraphics display, IPosition center, double radius);
    ...
    void Render(ISpatialGraphics display, IPosition[][] outlines);
